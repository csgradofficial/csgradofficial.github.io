...
- [x] Phase 9: Events calendar (branch `feature/events-calendar`, spec `specs/2026-09-21-events-calendar/`) — Embedded Google Calendar (`csgrad.official@gmail.com` primary calendar, made public, timezone locked to America/Chicago) as a new "Upcoming Events" section on `index.html`, placed between Hero and Contact. Month grid default with built-in view switcher; "Add to your calendar" button linking to the public sharing URL. Responsive iframe wrapper (16:10 desktop, 3:4 mobile). No nav change. Pending final QA + merge to `main`
